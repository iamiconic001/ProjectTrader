...
const Signup = () => {
  ...
  const handleClick = () => {
    ...
    setTimeout(() => {
      setShowAlert(false);
    }, 7000); // Hide alert after 7 seconds (adjust as needed)
  };
    ...
    <>
      ...
      <div className="form_container text-center" style={{ paddingTop: "80px", paddingBottom: "100px" }}>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            <label htmlFor="username" style={{ paddingBottom: "20px", marginRight: "15px", fontSize: "1.25em" }}>
              Username
            </label>
            <input
              style={{
          ...
          <div>
            <label htmlFor="email" style={{ paddingBottom: "20px", marginRight: "15px", fontSize: "1.25em" }}>
              Email
            </label>
            <input
              style={{
          ...
          <div>
            <label htmlFor="password" style={{ paddingBottom: "20px", marginRight: "15px", fontSize: "1.25em" }}>
              Password
            </label>
            <input
              style={{
